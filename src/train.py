...
def main() -> None:
    ...
    p.add_argument("--tie-qkv", type=str, default="none",
                   ...
                   help="QKV tying mode")
    # Position encoding
    p.add_argument("--pe-type", type=str, default="learned",
                   choices=["learned", "parametric_sin"],
                   help="Position encoding type")
    p.add_argument("--pe-init-period", type=float, default=11.0,
                   help="Init period for parametric_sin PE")
    # Token embedding rank
    p.add_argument("--token-emb-rank", type=int, default=0,
                   help="Token embedding rank (0=full)")
    ...
    model_cfg = ModelConfig(
        ...
        pe_init_period=args.pe_init_period,
        token_emb_rank=args.token_emb_rank,
    )
